package com.jeevanraksha.gateway.services;
...
import com.jeevanraksha.gateway.repository.UserRepository;
...
public class UserService {
    ...
    public boolean saveNewUser(User user) {
        try {
            ...
            user.setRoles(user.getRoles() == null ? Arrays.asList("PATIENT") : user.getRoles());
